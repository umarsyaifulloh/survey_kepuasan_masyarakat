            ...
            o.forEach((e) => {
                ...
                n.addEventListener("click", function() {
                    Swal.fire({
                        ...
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        confirmButtonText: "Ketemu modal deletenya :p !",
                        cancelButtonText: "No, cancel",
                        customClass: { confirmButton: "btn fw-bold btn-danger", cancelButton: "btn fw-bold btn-active-light-primary" },
                    }).then(function(n) {
                        n.value ?
                            Swal.fire({ text: "You have deleted all selected  files or folders!.", icon: "success", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn fw-bold btn-primary" } }).then(
                                function() {
                                    o.forEach((t) => {
                                        t.checked &&
                                            e
                            ...
                            "cancel" === n.dismiss &&
                            Swal.fire({ text: "Selected  files or folders was not deleted.", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn fw-bold btn-primary" } });
                    });
                });
        },
        s = () => {
                                ...
                                g.validate().then(function(t) {
                                    console.log("validated!"),
                                        ...
                                        setTimeout(function() {
                                            ...
                                            const o = e.row.add({ checkbox: a.innerHTML, name: m.outerHTML + t.outerHTML, size: "-", date: "-", action: r.innerHTML }).node();
                        ...
                        t.querySelector(".dropzone-remove-all").addEventListener("click", function() {
                            Swal.fire({
                                ...
                                e.value ?
                                    ...
                                    "cancel" === e.dismiss && Swal.fire({ text: "Your files was not removed!.", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } });
                            });
                        }),
