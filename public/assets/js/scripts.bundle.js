...
var KTMenu = function(e, t) {
    ...
    if (null != e) {
        var i = { dropdown: { hoverTimeout: 200, zindex: 105 }, accordion: { slideSpeed: 250, expand: !1 } },
            ...
            a = function(e) { e || (e = n.triggerElement), !0 !== m(e) && ("dropdown" === v(e) ? U(e) : "accordion" === v(e) && S(e), KTUtil.data(e).set("type", v(e))) },
            ...
            e = document.querySelector("#kt_header"),
                function() {
                    if (e) {
                        ...
                        t && t.on("kt.sticky.change", (function() { setTimeout((function() { KTMenu.updateDropdowns() }), 300) }))
                    }
                }()
        }
    }
}();
KTUtil.onDOMContentLoaded((function() { KTLayoutHeader.init() })), "undefined" != typeof module && void 0 !== module.exports && (module.exports = KTLayoutHeader);