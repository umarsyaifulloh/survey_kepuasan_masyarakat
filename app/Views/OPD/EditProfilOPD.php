                ...
                <div class="modal-header mb-3 border-0 justify-content">
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 text-center">
                            <a href="<?= site_url('/opd/profil'); ?>" class="btn btn-outline-dark btn-sm mt-auto" value="Go back!">
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                            ...
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">Edit Profil OPD</h3>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--begin::Card header-->
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            <!--begin::Form-->
                            <form class="form" method="POST" action="<?= site_url('/opd/updateprofil'); ?>" enctype="multipart/form-data">
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('<?= base_url(); ?>/img/logoopd/defaultLogo.png')">
                                                ...
                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Ubah Foto Profil">
                                                    ...
                                                    <!--begin::Inputs-->
                                                    <input class="<?= ($validation->hasError('opd_logo')) ? 'is-invalid' : ''; ?>" type="file" id="gambar" name="opd_logo" accept=".png, .jpg, .jpeg" />
                                                    <!--end::Inputs-->
                                                </label>
                                                <!--end::Label-->
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" id="opd_nama" name="opd_nama" class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_nama')) ? 'is-invalid' : ''; ?>" placeholder="Nama OPD" value="<?= (old('opd_nama')) ? old('opd_nama') : $opd['opd_nama']; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
                                    ...
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        <label class="col-lg-4 col-form-label fw-bold fs-6">Kode OPD
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" id="opd_kode" name="opd_kode" class="form-control form-control-lg form-control-solid" placeholder="Kode OPD" value="<?= (old('opd_kode')) ? old('opd_kode') : $opd['opd_kode']; ?>" disabled />
                                            <input type="hidden" name="opd_kode" value="<?= $opd['opd_kode']; ?>">
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" id="opd_email" name="opd_email" class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_email')) ? 'is-invalid' : ''; ?>" placeholder="Email" value="<?= (old('opd_email')) ? old('opd_email') : $opd['opd_email']; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" id="opd_alamat" name="opd_alamat" class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_alamat')) ? 'is-invalid' : ''; ?>" placeholder="Alamat" value="<?= (old('opd_alamat')) ? old('opd_alamat') : $opd['opd_alamat']; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="tel" id="opd_telp" name="opd_telp" class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_telp')) ? 'is-invalid' : ''; ?>" placeholder="Nomor Telepon" value="<?= (old('opd_telp')) ? old('opd_telp') : $opd['opd_telp']; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
