    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap mt-n5 mt-lg-0 me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">List OPD</h1>
                <!--end::Heading-->
                <!-- Start::Alert -->
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a type="button" href="<?= site_url('/opd/add'); ?>" class="btn btn-sm btn-primary my-1">
                        ...
                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="table1">
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted">
                                    ...
                                    <th class="w-10px text-center">Kode OPD</th>
                                    <th class="w-100px text-center">Nama OPD</th>
                            ...
                            <tbody id="myTable">
                                ...
                                <?php foreach ($listOpd as $opd) : ?>
                                    <tr>
                                        ...
                                        <td class="align-top">
                                            <a class="text-dark text-center fw-bolder d-block mb-1 fs-6"><?= $opd['opd_kode']; ?></a>
                                        </td>
                                        <td class="align-top">
                                        ...
                                        <td class="text-center d-flex justify-content-center in-line align-top" data-kt-menu="true">
                                            <a href="<?= site_url('/opd/detail/' . $opd['opd_kode']); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <a href="<?= site_url('/opd/edit/' . $opd['opd_kode']); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <form action="<?= site_url('/OPD/delete/' . $opd['opd_kode']); ?>" class="d-inline btn-delete">
                                                <?= csrf_field(); ?>
