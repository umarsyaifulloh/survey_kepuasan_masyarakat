                ...
                <div class="modal-header mb-3 border-0 justify-content">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-column align-items-start justify-content-center" data-kt-swapper="true" data-kt-swapper-mode="prepend">
                            <!--begin::Heading-->
                            <div class="mt-2 text-dark fw-bolder my-0 fs-2">Tambah OPD</div>
                            <!--end::Heading-->
                        </div>
                        <!--end::Page title=-->
                    </div>
                ...
                <div class="container-xxl" id="kt_content_container">
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            <!--begin::Form-->
                            <form action="<?= site_url('/opd/create'); ?>" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                                <?= csrf_field(); ?>
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8">
                                            <!--begin::Image input-->
                                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('/img/logoopd/defaultLogo.png')">
                                                <!--begin::Preview existing avatar-->
                                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url('/img/logoopd/defaultLogo.png')">
                                                </div>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="opd_nama" id="opd_nama" value="<?= old('opd_nama'); ?>" autofocus class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_nama')) ? 'is-invalid' : ''; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="opd_kode" id="opd_kode" value="<?= old('opd_kode'); ?>" autofocus class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_kode')) ? 'is-invalid' : ''; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="opd_email" id="opd_email" value="<?= old('opd_email'); ?>" autofocus class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_email')) ? 'is-invalid' : ''; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="opd_alamat" id="opd_alamat" value="<?= old('opd_alamat'); ?>" autofocus class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_alamat')) ? 'is-invalid' : ''; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="opd_telp" id="opd_telp" value="<?= old('opd_telp'); ?>" autofocus class="form-control form-control-lg form-control-solid <?= ($validation->hasError('opd_telp')) ? 'is-invalid' : ''; ?>" />
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="target_title" data-validator="notEmpty">
