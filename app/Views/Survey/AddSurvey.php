        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            <div class="modal-content rounded">
                <div class="modal-header pb-0 border-0 justify-content">
                    <div class="d-flex">
                        <div class="flex-shrink-0 text-center">
                            ...
                            <?php else : ?>
                            <a href="<?= site_url('/survey') ?>" class="btn btn-outline-dark mt-auto" value="Go back!">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                    class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
                                    <path
                                        d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z" />
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form class="form" method="POST" action="<?= site_url('/survey/create'); ?>"
                        enctype="multipart/form-data">
                        <!--begin::Heading-->
                        <?= csrf_field(); ?>
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Tambah Survey</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <input type="text"
                                ...
                                placeholder="Tuliskan Judul Survey" id="survey_judul" name="survey_judul" autofocus
                                value="<?= old('survey_judul'); ?>" />
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div data-field="target_title" data-validator="notEmpty">
                                    <?= $validation->getError('survey_judul'); ?>
                                </div>
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control form-control-solid" rows="3" id="survey_deskripsi"
                                ...
                                placeholder="Tuliskan Deskripsi Survey"><?= old('survey_deskripsi'); ?></textarea>
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div data-field="target_title" data-validator="notEmpty">
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    data-hide-search="true" data-placeholder="Pilih Tahun" id="survey_tahun"
                                    name="survey_tahun">
