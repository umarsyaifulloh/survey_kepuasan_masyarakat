            ...
            <div class="modal-content rounded">
                <div class="modal-header pb-0 border-0 justify-content">
                    <div class="d-flex">
                        <div class="flex-shrink-0 text-center">
                            ...
                            <a href="<?= site_url('/survey/detailsuper/' . $survey_id . '/' . $users['opd_kode']) ?>"
                            ...
                            <?php else : ?>
                            <a href="<?= site_url('/survey/detail/' . $survey_id) ?>"
                                class="btn btn-outline-dark mt-auto" value="Go back!" onclick="history.back()">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                    class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
                                    <path
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" method="POST"
                        action="<?= site_url('/pertanyaan/update/' . $pertanyaan['pertanyaan_id'] . '/' . $survey_id) ?>"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <input type="hidden" name="pertanyaan_id"
                                value="<?= (old('pertanyaan_id')) ? old('pertanyaan_id') : $pertanyaan['pertanyaan_id']; ?>">
                            <!--begin::Label-->
                            ...
                            <!--end::Label-->
                            <input type="text"
                                class="form-control form-control-solid <?= ($validation->hasError('pertanyaan_nama')) ? 'is-invalid' : ''; ?>"
                                placeholder="Tuliskan Pertanyaan" id="pertanyaan_nama" name="pertanyaan_nama" autofocus
                                value="<?= (old('pertanyaan_nama')) ? old('pertanyaan_nama') : $pertanyaan['pertanyaan_nama']; ?>" />
