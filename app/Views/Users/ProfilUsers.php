            ...
            <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
                ...
                <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                    ...
                    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap mt-n5 mt-lg-0 me-lg-2 pb-2 pb-lg-0"
                        ...
                        <!--begin::Heading-->
                        <h1 class="text-dark fw-bolder my-0 fs-2">Profil Admin</h1>
                        <!--end::Heading-->
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                ...
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-100px symbol-fixed position-relative">
                                        <img src="<?= base_url(); ?>/img/fotousers/<?= $users['users_image']; ?>"
                                            alt="image" />
                                    </div>
                                </div>
                                <!--end::Pic-->
                                    ...
                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a
                                                    class="text-gray-900 fs-2 fw-bolder me-1"><?= $users['users_nama']; ?></a>
                                                <a href="<?= site_url('/users/profil'); ?>"
                                                    class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_upgrade_plan"><?= $users['role_nama']; ?></a>
                                            </div>
                                            <!--end::Name-->
                                            <!--begin::Info-->
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div class="card mb-0" id="kt_profile_details_view">
                            ...
                            <div class="card-header cursor-pointer">
                                ...
                                <!--end::Card title-->
                                <!--begin::Action-->
                                <a href="<?= site_url('/users/editprofil'); ?>"
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fw-bolder fs-6 text-gray-800"><?= $users['users_nama']; ?></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <span class="fw-bold text-gray-800 fs-6"><?= $users['users_nip']; ?></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <span class="fw-bold text-gray-800 fs-6"><?= $users['users_email']; ?></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <span class="fw-bold text-gray-800 fs-6"><?= $users['users_alamat']; ?></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8 d-flex align-items-center">
                                        <span
                                            class="fw-bolder fs-6 text-gray-800 me-2"><?= $users['users_telp']; ?></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
