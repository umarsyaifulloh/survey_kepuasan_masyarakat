            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="#">
                        <!--begin::Row-->
                        <div class="row g-6 g-xl-9 mb-6 mb-xl-9 kartu-konten" style="display: none;" id="myProducts">
                            <?php
                            foreach ($listopd as $opd) : ?>
                                ...
                                <div class="col col-md-6 col-lg-4 col-xl-3 kartu">
                                    ...
                                    <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                        <!--begin::Name-->
                                        <a href="<?= site_url('/laporan/listtahun/' . $opd['opd_kode']); ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
                                            <!--begin::Image-->
                                            ...
                                            <!--end::Image-->
                                            <!--begin::Title-->
                                            <div class="fs-5 fw-bolder mb-2 card-title"><?= $opd['opd_nama']; ?></div>
                                            <!--end::Title-->
                                        </a>
                                        <!--end::Name-->
                                    </div>
