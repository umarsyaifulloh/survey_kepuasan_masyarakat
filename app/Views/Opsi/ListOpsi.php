    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap mt-n5 mt-lg-0 me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">Opsi Survey</h1>
                <!--end::Heading-->
            </div>
            <!--end::Page title=-->
        </div>
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a type="button" href="<?= site_url('opsi/addopsi'); ?>" class="btn btn-sm btn-primary my-1">
                            ...
                            <tbody id="myTable">
                                ...
                                <?php foreach ($listOpsi as $opsi) : ?>
                                    <tr>
                                        ...
                                        <td class="align-top">
                                            <a class="text-dark fw-bolder d-block mb-1 fs-6"><?= $opsi['opsi_nama']; ?></a>
                                        </td>
                                        <td class="d-flex justify-content-center in-line align-top text-center">
                                            <a href="<?= site_url('Opsi/edit/' . $opsi['opsi_id']); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <form action="<?= site_url('Opsi/delete/' . $opsi['opsi_id']); ?>" class="d-inline btn-delete">
                                                <?= csrf_field(); ?>
