        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form class="form" action="<?= site_url('/opsi/update/' . $opsi['opsi_id']); ?> " method="post">
                        <?= csrf_field(); ?>
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Ubah Opsi Jawaban Lain</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <input type="text"
                                ...
                                value="<?= (old('opsi_nama')) ? old('opsi_nama') : $opsi['opsi_nama']; ?>" />
                        ...
                        <!--end::Input group-->
                        <input type="hidden" name="opsi_id" value="<?= $opsi['opsi_id']; ?>">
                        <!--begin::Actions-->
