        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_target_form" class="form" action="/berita/update/<?= $berita['berita_id']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <!--begin::Heading-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid <?= ($validation->hasError('berita_judul')) ? 'is-invalid' : ''; ?>" placeholder="Tuliskan Judul Survey" id="berita_judul" name="berita_judul" autofocus value="<?= (old('berita_judul')) ? old('berita_judul') : $berita['berita_judul']; ?>" />
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea style="display:none;" class="form-control form-control-solid  <?= ($validation->hasError('berita_isi')) ? 'is-invalid' : ''; ?>" id="berita_isi" autofocus name="berita_isi" cols="30" rows="10"><?= (old('berita_isi')) ? old('berita_isi') : $berita['berita_isi']; ?></textarea>
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div data-field="target_title" data-validator="notEmpty">
                        ...
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            <input type="hidden" value="<?= session()->get('users_nip'); ?>" class="form-control form-control-solid" id="updated_by" placeholder="Tuliskan Nama Penulis" name="updated_by" />
                        </div>
                        <!--end::Input group-->
                        <input type="hidden" name="gambarLama" value="<?= $berita['berita_gambar']; ?>" />
                        <input type="hidden" name="berita_id" value="<?= (old('berita_id')) ? old('berita_id') : $berita['berita_id']; ?>">
                        <!--begin::Input group-->
                        <div class="fv-row mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Image input-->
                            <div class="image-input image-input-empty image-input-outline" data-kt-image-input="true" style="background-image: url(<?= base_url(); ?>/img/beritaimage/<?= $berita['berita_gambar']; ?>)">
