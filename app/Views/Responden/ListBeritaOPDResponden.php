                                                ...
                                                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 1}}">
                                                    <?php foreach ($listBeritaTerakhir as $beritaTerakhir) : ?>
                                                        ...
                                                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                                                            <!--begin::Title-->
                                                            <h3 class="fs-2hx text-dark mb-6"><?= $beritaTerakhir['berita_judul']; ?>
                                                            </h3>
                                                            <!--end::Title-->
                                                            <!--begin::Content-->
                                                            <div class="fs-4">
                                                                <!--begin::Author-->
                                                                <a class="text-gray-700"><?= $beritaTerakhir['users_nama']; ?></a>
                                                                <!--end::Author-->
                                                            </div>
                                                            <div class="fs-4 mb-6">
                                                                <!--begin::Date-->
                                                                <span class="text-muted">pada</span>
                                                                <span class="text-muted"><?= tanggal($beritaTerakhir['tanggal']); ?></span>
                                                                <!--end::Date-->
                                                            </div>
                                                            <!--end::Content-->
                                                            <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="<?= base_url(); ?>/img/beritaimage/<?= $beritaTerakhir['berita_gambar']; ?>">
                                                                <div class="overlay-wrapper min-h-300px bgi-no-repeat bgi-position-center bgi-size-cover card-rounded" style="background-image:url('<?= base_url(); ?>/img/beritaimage/<?= $beritaTerakhir['berita_gambar']; ?>')">
                                                                </div>
                                                            ...
                                                            <div class="fs-5 fw-bold text-gray-600">
                                                                <!--begin::Text-->
                                                                <p class="m-0 justify">
                                                                    <?= strip_only_tags_long($beritaTerakhir['berita_isi'], '<b><s><img><p><u><var><span><div><table>'); ?>
                                                                    <a href="<?= site_url('responden/detailberita/' . $beritaTerakhir['berita_id']); ?>" class="link-primary pe-1">Baca Selengkapnya</a>
                                                                </p>
                                                                <!--end::Text-->
                                                            </div>
                                                            <!--end::Description-->
